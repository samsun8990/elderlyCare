import {
    ...
    StatusBar, ScrollView, Keyboard, SafeAreaView
} from 'react-native'
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View>
                    ...
                    <View style={{ alignContent: 'center', justifyContent: "center" }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 20, borderBottomWidth: 1, paddingBottom: 4, width: '90%', marginBottom: 20 }}>
