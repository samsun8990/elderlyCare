import { StyleSheet, TextInput, View, Image, TouchableOpacity, Text, KeyboardAvoidingView, TouchableWithoutFeedback, 
    StatusBar,ScrollView,Keyboard,SafeAreaView } from 'react-native'
...
const ElderlyRegister = ({ route, navigation }) => {
    ...
    const handleElderlyRegister = async ({navigation}) => {
        ...
        try {
            ...
            if (userCredential) {
                ...
                await setDoc(docRef,
                    { email: email, fullname: fullname, password: password, phone: phone, gender: gender, avatar: "https://static.thenounproject.com/png/5034901-200.png", role:"elder" },
                    { merge: true })
                    .then(() => {
